...
WinPrint.close();
		...
		<a href="gdes.php" style="text-decoration:none;color:red;padding-left:50px;">Group By Designation</a>
		</div>
		<div style="position:absolute;top:310px;left:250px;height:auto;width:1000px;background-color:white;" id="p">
			<?php
			include('db.php');
			$query="select DISTINCT designation from employee_details";
			$result=mysql_query($query) or die(mysql_error());
				...
				{
					echo "<center><table border='1'><br><caption>".$row1['designation']."<caption>";
					...
					echo "<th>Edit</th>";
					echo "<th>Delete</th>";
					$query="select * from employee_details where designation='".$row1['designation']."'";
