...
<html>
	...
	<body>
		...
		<?php
		include('db.php');
		$query="select * from single_leave where status='unknown'";
		...
		if(mysql_num_rows($result)==0)
				...
				else
				{
					...
					echo "<th>Reject</th>";
						...
						echo "<td><center><a href='accept_leave.php?id=$id'>Accept</a></center></td>";
						echo "<td><center><a href='reject_leave.php?id=$id'>Reject</a></center></td>";
						echo "</tr>";
						}
					echo "</table></center>";
